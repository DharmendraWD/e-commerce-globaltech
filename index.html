...
<header class="ecomNav-header">
    ...
    <a href="/" class="ecomNav-logo"><img src="./images//logo/logo-1.png" style="width: 150px;" alt="" ></a>
 ...
 <div class="cartImgHeading">
     <img src="./images/brand/b1.png" class="cartImg" alt="">
                     <h3>watermelon</h3>
 </div>
...
<!-- Header section end -->
    ...
    <a href="./explore.html"><button type="button" class="btn btn-light btn--e-brand">Shop Now !</button></a> 

            <p>Web Devoloper<br />The code for this Slider is provided below</p>
          </div>
          <img
            class="crousalUpper-slider_img"
    ...
    <a href="./explore.html"><button type="button" class="btn btn-light btn--e-brand">Shop Now !</button></a> 
        ...
        <!-- onclick js -->
        <a class="crousalUpper-prev" onclick="crousalUpperPlusSlides(-1)"
          ><i class="bx bx-chevron-left"></i
        ></a>
        <a class="crousalUpper-next" onclick="crousalUpperPlusSlides(1)"
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                                ...
                                <a class="promotion" href="./explore.html">
                                    ...
                                    <div class="promotion__content">
                                        <div class="promotion__text-wrap">
                                            <div class="promotion__text-1">
                                                ...
                                                <span class="u-c-secondary">EXPLORE OUR</span></div>
                                            <div class="promotion__text-2">
                                                 <span class="u-c-brand">GENUINE</span></div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                                ...
                                <a class="promotion" href="./newarrival.html">
                                    <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <div class="promotion__content">
                                        <div class="promotion__text-wrap">
                                            <div class="promotion__text-1">
                                                ...
                                                <span class="u-c-brand">2024</span></div>
                                            <div class="promotion__text-2">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                                ...
                                <a class="promotion" href="./whatsnew.html">
                                    <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <div class="promotion__content">
                                        <div class="promotion__text-wrap">
                                            <div class="promotion__text-1">
                                                ...
                                                <span class="u-c-secondary">WHAT"S NEW IN</span>          <span class="u-c-brand">IN THIS YEAR?</span></div></div>
                                            <div class="promotion__text-2">
                                ...
                                <div class="testimonial">
                                    ...
                                    <div class="testimonial__content-wrap">
                                        ...
                                        <blockquote class="testimonial__block-quote">
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum enim consectetur, blanditiis soluta quae accusantium maiores aut ut facere porro in accusamus libero hic earum minus numquam necessitatibus officiis modi?</p>
                                        </blockquote>
